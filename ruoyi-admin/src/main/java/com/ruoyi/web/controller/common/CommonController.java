...
import com.ruoyi.system.domain.vo.common.UploadFileVO;
import com.ruoyi.system.domain.vo.common.UploadFilesVO;
...
public class CommonController {
    ...
    public AjaxResult uploadFile(MultipartFile file) {
        try {
            ...
            UploadFileVO vo = new UploadFileVO(url, fileName, FileUtils.getName(fileName), file.getOriginalFilename());
